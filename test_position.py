...
#     # ตรวจหา seeable จาก manufacturer_data แต่ไม่เชื่อมต่อ
...
#                 "rssi": rssi,
#             }
#             print(f"[พบ seeable จาก manufacturer data] {mac} RSSI: {rssi}")
#             break  # แค่เก็บไว้ ไม่ต้องเชื่อมต่อ

#     # ตรวจหา Ruuvi จาก TARGET_BLE_NAMES
#     if name in TARGET_BLE_NAMES:
#         # เก็บข้อมูลไว้ใน list ถ้ายังไม่เคยเจอ
...
#         # เชื่อมต่อกับ Ruuvi ทันที (ถ้ายังไม่เชื่อมต่ออยู่)
...
#     for mfg_id, mfg_data in adv_data.manufacturer_data.items():
#         if SEEABLE_SIGNATURE in mfg_data:
#             seeable_info = {
#                 "name": "seeable",
#                 "mac": mac,
#                 "rssi": rssi,
...
#                 if d["name"] in target_ble_names and d["name"] in RUUVI_POSITIONS:
#                     ruuvi_data.append(
#                         {
#                             "name": d["name"],
#                             "rssi": d["rssi"],
...
#                         GATEWAY_POS, ruuvi_data, seeable_info["rssi"]
#                     )
...
#                             if name in TARGET_BLE_NAMES or name == "seeable":
...
#     is_seeable = any(
#         SEEABLE_SIGNATURE in m for m in adv_data.manufacturer_data.values()
#     )
#     if name in TARGET_BLE_NAMES or is_seeable:
#         if mac not in rssi_history:
...
#             position = None
#             seeable_mac = seeable_info["mac"]
#             if (
#                 len(ruuvi_data) >= 2
#                 and seeable_mac in rssi_history
#                 and rssi_history[seeable_mac]["history"]
#             ):
#                 try:
#                     seeable_avg = sum(rssi_history[seeable_mac]["history"]) / len(
#                         rssi_history[seeable_mac]["history"]
#                     )
#                     pos = estimate_seeable_position(
